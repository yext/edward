...
.. image:: https://godoc.org/github.com/theothertomelliott/gopsutil-nocgo?status.svg
        :target: http://godoc.org/github.com/theothertomelliott/gopsutil-nocgo
...
.. highlights:: Breaking Changes!
   ...
   Breaking changes is introduced at v2. See `issue 174 <https://github.com/theothertomelliott/gopsutil-nocgo/issues/174>`_ .


Migrating to v2
-------------------------

On gopsutil itself, `v2migration.sh <https://github.com/theothertomelliott/gopsutil-nocgo/blob/v2/v2migration.sh>`_ is used for migration. It can not be commonly used, but it may help you with migration.
...
.. code:: go
   ...
   import (
       ...
       "github.com/theothertomelliott/gopsutil-nocgo/mem"
   )
...
see http://godoc.org/github.com/theothertomelliott/gopsutil-nocgo
